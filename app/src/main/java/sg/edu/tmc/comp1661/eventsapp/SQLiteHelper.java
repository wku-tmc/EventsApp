...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_DATETIME = "EVENT_DATETIME";
    public static final String COLUMN_LOCATION = "EVENT_LOCATION";
    public static final String COLUMN_ORGANISER = "EVENT_ORGANISER";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_NAME + " ( "
                ...
                + COLUMN_DATETIME + " VARCHAR, "
                + COLUMN_ORGANISER + " VARCHAR, "
    ...
    public void insertRecord(Event event) {
        ...
        contentValues.put(COLUMN_DATETIME, event.getDatetime());
        contentValues.put(COLUMN_LOCATION, event.getLocation());
        contentValues.put(COLUMN_ORGANISER, event.getOrganiser());
    ...
    public ArrayList<Event> getAllRecords() {
        ...
        if (cursor.getCount() > 0) {
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                event.setOrganiser(cursor.getString(4));
